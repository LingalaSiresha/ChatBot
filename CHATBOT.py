<!DOCTYPE html>
<!-- saved from url=(0084)https://colab.research.google.com/drive/1JKme15hmyosV5At7t8AGTjjV2GPPKyS7?authuser=1 -->
...
</custom-style><link rel="stylesheet" href="./CHATBOT_files/css(2)"><link rel="stylesheet" href="./CHATBOT_files/css(3)"><custom-style>
  <style is="custom-style">html {
...
</custom-style><script async="async" type="text/javascript" src="./CHATBOT_files/editor.main.js.download"></script><script async="" type="text/javascript" charset="UTF-8" src="./CHATBOT_files/rs=AA2YrTtAN-lxYQLYrIOtly-Us9d7MZjpQg" nonce=""></script><link rel="stylesheet" type="text/css" data-name="vs/editor/editor.main" href="./CHATBOT_files/editor.main.css"><link type="text/css" rel="stylesheet" href="./CHATBOT_files/rs=AA2YrTv8JqiXh0uxWGIHJ2MxRvppLpaobw"><script async="async" type="text/javascript" src="./CHATBOT_files/editor.main.nls.js.download"></script><style type="text/css">.MathJax_Hover_Frame {border-radius: .25em; -webkit-border-radius: .25em; -moz-border-radius: .25em; -khtml-border-radius: .25em; box-shadow: 0px 0px 15px #83A; -webkit-box-shadow: 0px 0px 15px #83A; -moz-box-shadow: 0px 0px 15px #83A; -khtml-box-shadow: 0px 0px 15px #83A; border: 1px solid #A6D ! important; display: inline-block; position: absolute}
...
</style><script async="async" type="text/javascript" src="./CHATBOT_files/markdown.js.download"></script><script src="./CHATBOT_files/api.js.download" nonce=""></script><script src="./CHATBOT_files/api.js(1).download" nonce=""></script><style type="text/css" media="screen" class="monaco-colors">.codicon-add:before { content: '\ea60'; }
...
.mtku { text-decoration: underline; text-underline-position: under; }</style><style type="text/css" media="screen">
		...
		.monaco-editor .codelens-decoration._ee1f61 span.codicon { line-height: 19px; font-size: 12px; }
          ...
          </script><script src="./CHATBOT_files/external_polymer_binary.js.download" nonce=""></script><script nonce="">
  ...
  </paper-toast><paper-toast text="" id="message-area-secondary" class="message-area startup" style="outline: none; position: fixed; box-sizing: border-box; left: 0px; top: 595.2px; max-width: 288px; max-height: 48.8px; display: none;" aria-hidden="true">
    <span class="paper-toast-extra"></span>
    <paper-icon-button class="close" icon="icons:close" role="button" tabindex="0" aria-disabled="false">
    </paper-icon-button>
...
// Google Inc.
    ...
    <div id="header" class="horizontal layout">
      ...
      <div id="header-content">
        ...
        <!--?lit$096929133$-->
      <div id="header-logo">
          <!--?lit$096929133$--><a href="https://drive.google.com/drive/search?q=owner%3Ame%20(type%3Aapplication%2Fvnd.google.colaboratory%20%7C%7C%20type%3Aapplication%2Fvnd.google.colab)&amp;authuser=1" aria-label="View in Google Drive">
    ...
    <input id="doc-name" class="doc-name" maxlength="259" autocomplete="off" command="rename" aria-label="Notebook name" style="width: 111.95px;"><colab-input-sizer style="left: -1000%; position: absolute; font-family: &quot;Google Sans&quot;, Roboto, Noto, sans-serif; font-size: 18px; font-weight: 400; letter-spacing: normal; padding-left: 3px; padding-right: 4px; white-space: pre;">CHATBOT.py_</colab-input-sizer>
    <paper-tooltip for="doc-name" id="doc-name-tooltip" offset="8" role="tooltip" tabindex="-1" style="left: 105.062px; top: 41px;">
      <!--?lit$096929133$-->Rename notebook
    <div class="tooltip-with-shortcut">Rename notebook</div></paper-tooltip>
        ...
        <div><!----><div id="top-menubar" class="goog-menubar format-lightborder" role="menubar" tabindex="0" style="user-select: none;"><!--?lit$096929133$--><div class="goog-menu-button goog-inline-block" id="file-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$096929133$-->File</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div><div class="goog-menu-button goog-inline-block" id="edit-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$096929133$-->Edit</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div><div class="goog-menu-button goog-inline-block" id="view-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$096929133$-->View</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div><div class="goog-menu-button goog-inline-block" id="insert-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$096929133$-->Insert</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div><div class="goog-menu-button goog-inline-block" id="runtime-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$096929133$-->Runtime</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div><div class="goog-menu-button goog-inline-block" id="tools-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$096929133$-->Tools</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div><div class="goog-menu-button goog-inline-block" id="help-menu-button" role="button" aria-expanded="false" aria-haspopup="true" style="user-select: none;"><div class="goog-inline-block goog-menu-button-outer-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-inner-box" style="user-select: none;"><div class="goog-inline-block goog-menu-button-caption" style="user-select: none;"><!--?lit$096929133$-->Help</div><div class="goog-inline-block goog-menu-button-dropdown" style="user-select: none;">&nbsp;</div></div></div></div><colab-last-saved-indicator command="show-history" title="" style="user-select: none;">All changes saved</colab-last-saved-indicator></div>
...
(sireshal2001@gmail.com)" href="https://accounts.google.com/SignOutOptions?hl=en&amp;continue=https://colab.research.google.com/drive/1JKme15hmyosV5At7t8AGTjjV2GPPKyS7%3Fauthuser%3D1" role="button" tabindex="0"><img class="gb_Ba gbii" src="./CHATBOT_files/unnamed.png" srcset="https://lh3.googleusercontent.com/ogw/AOh-ky0WLtmyoOiUBn0IV9iuYCegvZHsq5fxjIzgVxId=s32-c-mo 1x, https://lh3.googleusercontent.com/ogw/AOh-ky0WLtmyoOiUBn0IV9iuYCegvZHsq5fxjIzgVxId=s64-c-mo 2x " alt="" aria-hidden="true" data-noaft=""></a><div class="gb_4a"></div><div class="gb_3a"></div></div></div></div><div style="overflow: hidden; position: absolute; top: 0px; visibility: hidden; width: 372px; z-index: 991; height: 0px; margin-top: 57px; right: 0px; margin-right: 4px;"></div></div></div><script nonce="">this.gbar_=this.gbar_||{};(function(_){var window=this;
try{
...
// Google Inc.
      ...
      <!--?lit$096929133$--><colab-left-pane role="complementary" aria-label="left pane"><!----><div class="colab-left-pane-nib layout vertical">
  ...
  <paper-icon-button command="toggle-header" icon="icons:expand-less" id="toggle-header-button" aria-label="Toggle header visibility" role="button" tabindex="0" aria-disabled="false">
      ...
      <!--?lit$096929133$--><colab-tab-pane class="layout vertical grow no-header focused" align="horizontal"><!---->
  <div class="layout vertical grow">
    <div class="tab-pane-header layout horizontal noshrink">
      ...
      <paper-tab noink="" title="" class="iron-selected" role="tab" aria-disabled="false" aria-selected="true" tabindex="0">
          <div class="colab-tab-header"><!--?lit$096929133$--><span class="colab-tab-title"><!--?lit$096929133$--><!--?lit$096929133$-->Notebook<!--?--></span>
          <!--?lit$096929133$--><!--?--></div>
      ...
      <div class="notebook-scrolling-horizontal">
        <div class="notebook-content-background">
          ...
          <div class="notebook-content ">
            <!--?lit$096929133$--><div class="add-cell">
...
Ctrl+M B">
            ...
            <div class="notebook-cell-list"><div class="cell code b205360537-workaround code-has-output icon-scrolling focused" id="cell-P-v3EpbLtteP" tabindex="-1" style=""><div class="cell-toolbar sticky"><colab-cell-toolbar><paper-icon-button class="colab-icon" noink="" icon="icons:arrow-upward" title="Move cell up
...
Requirement already satisfied: pyparsing&gt;=2.0.2 in /usr/local/lib/python3.7/dist-packages (from packaging-&gt;numexpr&gt;=2.6.2-&gt;tables==3.6.1) (3.0.9)
             ...
             <hr>
           </div></div><div class="cell code b205360537-workaround code-has-output icon-scrolling" id="cell-BFkME21q7k0m" tabindex="-1" style=""><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output"><div class="inputarea horizontal layout code"><div class="cell-gutter"><!-- Bounding range for vertical scrolling of icons --><div class="cell-execution-container"><colab-run-button title="Run cell (Ctrl+Enter)
cell has not been executed in this session

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 3.926s" role="button" aria-label="Run cell"></colab-run-button></div></div><div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk6">!</span><span class="mtk1">pip&nbsp;install&nbsp;-U&nbsp;ipython</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div><div class="output"><div class="output-header"></div><div class="output-content"><div class="output-info"><div class="output-icon clear_outputs_enabled output-icon-selected" title="Clear output

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 3.926s"><iron-icon class="collaborator collaborator-img-me collaborator-img-selected"></iron-icon>
          <iron-icon icon="icons:cancel" command="clear-focused-or-selected-outputs">
          </iron-icon>
        </div></div><div class="output-iframe-container"><div class="output-iframe-sizer"><div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>Looking in indexes: <a rel="nofollow" target="_blank" href="https://pypi.org/simple">https://pypi.org/simple</a>, <a rel="nofollow" target="_blank" href="https://us-python.pkg.dev/colab-wheels/public/simple/">https://us-python.pkg.dev/colab-wheels/public/simple/</a>
...
Requirement already satisfied: wcwidth in /usr/local/lib/python3.7/dist-packages (from prompt-toolkit!=3.0.0,!=3.0.1,&lt;3.1.0,&gt;=2.0.0-&gt;ipython) (0.2.5)
             ...
             <hr>
           </div></div><div class="cell code b205360537-workaround code-has-output icon-scrolling" id="cell-UIAwZZgl74kn" tabindex="-1" style=""><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output"><div class="inputarea horizontal layout code"><div class="cell-gutter"><!-- Bounding range for vertical scrolling of icons --><div class="cell-execution-container"><colab-run-button title="Run cell (Ctrl+Enter)
cell has not been executed in this session

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 10.656s" role="button" aria-label="Run cell"></colab-run-button></div></div><div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk6">!</span><span class="mtk1">python&nbsp;-m&nbsp;spacy&nbsp;download&nbsp;en</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div><div class="output"><div class="output-header"></div><div class="output-content"><div class="output-info"><div class="output-icon clear_outputs_enabled output-icon-selected" title="Clear output

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 10.656s"><iron-icon class="collaborator collaborator-img-me collaborator-img-selected"></iron-icon>
          <iron-icon icon="icons:cancel" command="clear-focused-or-selected-outputs">
          </iron-icon>
        </div></div><div class="output-iframe-container"><div class="output-iframe-sizer"><div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>2022-07-20 14:14:11.344574: W tensorflow/stream_executor/platform/default/dso_loader.cc:55] Could not load dynamic library 'libnvinfer.so.6'; dlerror: libnvinfer.so.6: cannot open shared object file: No such file or directory; LD_LIBRARY_PATH: /usr/local/nvidia/lib:/usr/local/nvidia/lib64
2022-07-20 14:14:11.344714: W tensorflow/stream_executor/platform/default/dso_loader.cc:55] Could not load dynamic library 'libnvinfer_plugin.so.6'; dlerror: libnvinfer_plugin.so.6: cannot open shared object file: No such file or directory; LD_LIBRARY_PATH: /usr/local/nvidia/lib:/usr/local/nvidia/lib64
2022-07-20 14:14:11.344731: W tensorflow/compiler/tf2tensorrt/utils/py_utils.cc:30] Cannot dlopen some TensorRT libraries. If you would like to use Nvidia GPU with TensorRT, please make sure the missing libraries mentioned above are installed properly.
<span style="color: var(--ansi-yellow);">⚠ As of spaCy v3.0, shortcuts like 'en' are deprecated. Please use the
full pipeline package name 'en_core_web_sm' instead.</span><span>
Looking in indexes: <a rel="nofollow" target="_blank" href="https://pypi.org/simple">https://pypi.org/simple</a>, <a rel="nofollow" target="_blank" href="https://us-python.pkg.dev/colab-wheels/public/simple/">https://us-python.pkg.dev/colab-wheels/public/simple/</a>
Collecting en-core-web-sm==3.3.0
  Downloading <a rel="nofollow" target="_blank" href="https://github.com/explosion/spacy-models/releases/download/en_core_web_sm-3.3.0/en_core_web_sm-3.3.0-py3-none-any.whl">https://github.com/explosion/spacy-models/releases/download/en_core_web_sm-3.3.0/en_core_web_sm-3.3.0-py3-none-any.whl</a> (12.8 MB)
</span>     |████████████████████████████████| 12.8 MB 6.8 MB/s 
...
<span style="color: var(--ansi-green);">✔ Download and installation successful</span><span>
You can now load the package via spacy.load('en_core_web_sm')
</span></pre></div></div><div></div></colab-static-output-renderer></div></div></div></div></div></div></div></div><div class="add-cell">
             <hr>
           </div></div><div class="cell code b205360537-workaround code-has-output icon-scrolling" id="cell-3onINGG55chP" tabindex="-1" style=""><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output"><div class="inputarea horizontal layout code"><div class="cell-gutter"><!-- Bounding range for vertical scrolling of icons --><div class="cell-execution-container"><colab-run-button title="Run cell (Ctrl+Enter)
cell has not been executed in this session

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 4.605s" role="button" aria-label="Run cell"></colab-run-button></div></div><div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk6">!</span><span class="mtk1">pip&nbsp;install&nbsp;nest_asyncio==</span><span class="mtk7">1.3.3</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div><div class="output"><div class="output-header"></div><div class="output-content"><div class="output-info"><div class="output-icon clear_outputs_enabled output-icon-selected" title="Clear output

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 4.605s"><iron-icon class="collaborator collaborator-img-me collaborator-img-selected"></iron-icon>
          <iron-icon icon="icons:cancel" command="clear-focused-or-selected-outputs">
          </iron-icon>
        </div></div><div class="output-iframe-container"><div class="output-iframe-sizer"><div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>Looking in indexes: <a rel="nofollow" target="_blank" href="https://pypi.org/simple">https://pypi.org/simple</a>, <a rel="nofollow" target="_blank" href="https://us-python.pkg.dev/colab-wheels/public/simple/">https://us-python.pkg.dev/colab-wheels/public/simple/</a>
Requirement already satisfied: nest_asyncio==1.3.3 in /usr/local/lib/python3.7/dist-packages (1.3.3)
             ...
             <hr>
           </div></div><div class="cell code b205360537-workaround code-has-output icon-scrolling" id="cell-MiQORge8usBM" tabindex="-1" style=""><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output"><div class="inputarea horizontal layout code"><div class="cell-gutter"><!-- Bounding range for vertical scrolling of icons --><div class="cell-execution-container"><colab-run-button title="Run cell (Ctrl+Enter)
cell has not been executed in this session

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 0.44s" role="button" aria-label="Run cell"></colab-run-button></div></div><div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk18">import</span><span class="mtk1">&nbsp;os</span></span><br><span><span class="mtk18">import</span><span class="mtk1">&nbsp;rasa</span></span><br><span><span class="mtk18">import</span><span class="mtk1">&nbsp;nest_asyncio</span></span><br><span><span class="mtk1">nest_asyncio.apply()</span></span><br><span><span class="mtk14">print</span><span class="mtk1">(</span><span class="mtk26">"event&nbsp;loop&nbsp;ready"</span><span class="mtk1">)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div><div class="output"><div class="output-header"></div><div class="output-content"><div class="output-info"><div class="output-icon clear_outputs_enabled output-icon-selected" title="Clear output

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 0.44s"><iron-icon class="collaborator collaborator-img-me collaborator-img-selected"></iron-icon>
          <iron-icon icon="icons:cancel" command="clear-focused-or-selected-outputs">
          </iron-icon>
        </div></div><div class="output-iframe-container"><div class="output-iframe-sizer"><div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>event loop ready
</pre></div></div><div></div></colab-static-output-renderer></div></div></div></div></div></div></div></div><div class="add-cell">
             <hr>
           </div></div><div class="cell code b205360537-workaround icon-scrolling" id="cell-fxd5d2h8vORJ" tabindex="-1" style=""><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output"><div class="inputarea horizontal layout code"><div class="cell-gutter"><!-- Bounding range for vertical scrolling of icons --><div class="cell-execution-container"><colab-run-button title="Run cell (Ctrl+Enter)
cell has not been executed in this session" role="button" aria-label="Run cell"></colab-run-button></div></div><div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk18">from</span><span class="mtk1">&nbsp;rasa.cli.scaffold&nbsp;</span><span class="mtk18">import</span><span class="mtk1">&nbsp;create_initial_project</span></span><br><span><span class="mtk1">project&nbsp;=&nbsp;</span><span class="mtk26">"test_project"</span></span><br><span><span class="mtk1">create_initial_project(project)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div><div class="output"><div class="output-header"></div><div class="output-content" style="display: none;"><div class="output-info"></div><div class="output-iframe-container"><div class="output-iframe-sizer"></div></div></div></div></div></div><div class="add-cell">
             <hr>
           </div></div><div class="cell code b205360537-workaround code-has-output icon-scrolling" id="cell-T8uON3kE8i3A" tabindex="-1" style=""><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output"><div class="inputarea horizontal layout code"><div class="cell-gutter"><!-- Bounding range for vertical scrolling of icons --><div class="cell-execution-container"><colab-run-button title="Run cell (Ctrl+Enter)
cell has not been executed in this session

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 0.651s" role="button" aria-label="Run cell"></colab-run-button></div></div><div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk8">#move&nbsp;into&nbsp;project&nbsp;directory&nbsp;and&nbsp;show&nbsp;files</span></span><br><span><span class="mtk1">os.chdir(project)</span></span><br><span><span class="mtk14">print</span><span class="mtk1">(os.listdir(</span><span class="mtk26">"."</span><span class="mtk1">))</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div><div class="output"><div class="output-header"></div><div class="output-content"><div class="output-info"><div class="output-icon clear_outputs_enabled output-icon-selected" title="Clear output

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 0.651s"><iron-icon class="collaborator collaborator-img-me collaborator-img-selected"></iron-icon>
          <iron-icon icon="icons:cancel" command="clear-focused-or-selected-outputs">
          </iron-icon>
        </div></div><div class="output-iframe-container"><div class="output-iframe-sizer"><div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>['tests', '__pycache__', 'config.yml', 'data', 'credentials.yml', '__init__.py', 'domain.yml', 'endpoints.yml', 'actions.py']
</pre></div></div><div></div></colab-static-output-renderer></div></div></div></div></div></div></div></div><div class="add-cell">
             <hr>
           </div></div><div class="cell code b205360537-workaround code-has-output icon-scrolling" id="cell-zKFFBh47w2jA" tabindex="-1" style=""><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output"><div class="inputarea horizontal layout code"><div class="cell-gutter"><!-- Bounding range for vertical scrolling of icons --><div class="cell-execution-container"><colab-run-button title="Run cell (Ctrl+Enter)
cell has not been executed in this session

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 0.603s" role="button" aria-label="Run cell"></colab-run-button></div></div><div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk1">config=</span><span class="mtk26">"config.yml"</span></span><br><span><span class="mtk1">training_files=</span><span class="mtk26">"data/"</span></span><br><span><span class="mtk1">domain=</span><span class="mtk26">"domain.yml"</span></span><br><span><span class="mtk1">output=</span><span class="mtk26">"models/"</span></span><br><span><span class="mtk14">print</span><span class="mtk1">(config,training_files,domain,output)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div><div class="output"><div class="output-header"></div><div class="output-content"><div class="output-info"><div class="output-icon clear_outputs_enabled output-icon-selected" title="Clear output

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 0.603s"><iron-icon class="collaborator collaborator-img-me collaborator-img-selected"></iron-icon>
          <iron-icon icon="icons:cancel" command="clear-focused-or-selected-outputs">
          </iron-icon>
        </div></div><div class="output-iframe-container"><div class="output-iframe-sizer"><div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>config.yml data/ domain.yml models/
</pre></div></div><div></div></colab-static-output-renderer></div></div></div></div></div></div></div></div><div class="add-cell">
             <hr>
           </div></div><div class="cell code b205360537-workaround code-has-output icon-scrolling" id="cell-J1Ozx9coxVUL" tabindex="-1" style=""><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output"><div class="inputarea horizontal layout code"><div class="cell-gutter"><!-- Bounding range for vertical scrolling of icons --><div class="cell-execution-container"><colab-run-button title="Run cell (Ctrl+Enter)
cell has not been executed in this session

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 68.733s" role="button" aria-label="Run cell"></colab-run-button></div></div><div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk1">model_path=rasa.train(domain,config,[training_file</span><span class="mtk1">s],output)</span></span><br><span><span class="mtk14">print</span><span class="mtk1">(model_path)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div><div class="output"><div class="output-header"></div><div class="output-content"><div class="output-info"><div class="output-icon clear_outputs_enabled output-icon-selected" title="Clear output

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 68.733s"><iron-icon class="collaborator collaborator-img-me collaborator-img-selected"></iron-icon>
          <iron-icon icon="icons:cancel" command="clear-focused-or-selected-outputs">
          </iron-icon>
        </div></div><div class="output-iframe-container"><div class="output-iframe-sizer"><div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre><span style="color: var(--ansi-bright-blue);">Training Core model...</span><span>
</span></pre></div><div class="stream output_text"><pre>Processed Story Blocks: 100%|██████████| 5/5 [00:00&lt;00:00, 311.32it/s, # trackers=1]
Processed Story Blocks: 100%|██████████| 5/5 [00:00&lt;00:00, 160.34it/s, # trackers=5]
Processed Story Blocks: 100%|██████████| 5/5 [00:00&lt;00:00, 125.16it/s, # trackers=20]
Processed Story Blocks: 100%|██████████| 5/5 [00:00&lt;00:00, 102.46it/s, # trackers=24]
Processed trackers: 100%|██████████| 5/5 [00:00&lt;00:00, 101.99it/s, # actions=16]
Processed actions: 16it [00:00, 587.63it/s, # examples=16]
Processed trackers: 100%|██████████| 231/231 [00:06&lt;00:00, 37.39it/s, # actions=126]
Epochs: 100%|██████████| 100/100 [00:14&lt;00:00,  6.71it/s, t_loss=0.086, loss=0.013, acc=1.000]
</pre></div><div class="stream output_text"><pre><span style="color: var(--ansi-bright-blue);">Core model training completed.</span><span>
</span><span style="color: var(--ansi-bright-blue);">Training NLU model...</span><span>
</span></pre></div><div class="stream output_text"><pre><span style="color: var(--ansi-bright-yellow);">/usr/local/lib/python3.7/dist-packages/rasa/utils/common.py:363: UserWarning: You specified 'DIET' to train entities, but no entities are present in the training data. Skip training of entities.
Epochs: 100%|██████████| 100/100 [00:16&lt;00:00,  5.96it/s, t_loss=1.508, i_loss=0.116, i_acc=1.000]
</span></pre></div><div class="stream output_text"><pre><span style="color: var(--ansi-bright-blue);">NLU model training completed.</span><span>
</span><span style="color: var(--ansi-bright-green);">Your Rasa model is trained and saved at '/content/test_project/models/20220720-141607.tar.gz'.</span><span>
models/20220720-141607.tar.gz
</span></pre></div></div><div></div></colab-static-output-renderer></div></div></div></div></div></div></div></div><div class="add-cell">
             <hr>
           </div></div><div class="cell code b205360537-workaround code-has-output icon-scrolling" id="cell-j2IgZCqs1tO-" tabindex="-1" style=""><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output"><div class="inputarea horizontal layout code"><div class="cell-gutter"><!-- Bounding range for vertical scrolling of icons --><div class="cell-execution-container"><colab-run-button title="Run cell (Ctrl+Enter)
cell has not been executed in this session

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 54.175s" role="button" aria-label="Run cell"></colab-run-button></div></div><div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk18">from</span><span class="mtk1">&nbsp;rasa.jupyter&nbsp;</span><span class="mtk18">import</span><span class="mtk1">&nbsp;chat</span></span><br><span><span class="mtk1">endpoints&nbsp;=&nbsp;</span><span class="mtk26">'endpoints.yml'</span></span><br><span><span class="mtk1">chat(model_path,endpoints)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div><div class="output"><div class="output-header"></div><div class="output-content"><div class="output-info"><div class="output-icon clear_outputs_enabled output-icon-selected" title="Clear output

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 54.175s"><iron-icon class="collaborator collaborator-img-me collaborator-img-selected"></iron-icon>
          <iron-icon icon="icons:cancel" command="clear-focused-or-selected-outputs">
          </iron-icon>
        </div></div><div class="output-iframe-container"><div class="output-iframe-sizer"><div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>Your bot is ready to talk! Type your messages here or send '/stop'.
hello
<span style="color: var(--ansi-bright-green);">Hey! How are you?</span><span>
iam good what about u
</span><span style="color: var(--ansi-bright-green);">I am a bot, powered by Rasa.</span><span>
wow cool!!
</span><span style="color: var(--ansi-bright-green);">Bye</span><span>
okie byee
</span><span style="color: var(--ansi-bright-green);">Bye</span><span>
/stop
</span></pre></div></div><div></div></colab-static-output-renderer></div></div></div></div></div></div></div></div><div class="add-cell">
             <hr>
           </div></div><div class="cell code b205360537-workaround code-has-output icon-scrolling" id="cell-V4Nw6UmT-Mrh" tabindex="-1" style=""><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="codecell-input-output"><div class="inputarea horizontal layout code"><div class="cell-gutter"><!-- Bounding range for vertical scrolling of icons --><div class="cell-execution-container"><colab-run-button title="Run cell (Ctrl+Enter)
cell has not been executed in this session

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 28.301s" role="button" aria-label="Run cell"></colab-run-button></div></div><div class="editor flex lazy-editor" style=""><pre class="lazy-virtualized" style="font-size: 14px; line-height: 19px;"><pre class="lazy-gutter"></pre><pre class="monaco-colorized colab colab" data-lang="notebook-python"><span><span class="mtk1">chat(model_path,&nbsp;endpoints)</span></span><br></pre></pre></div><colab-form class="formview vertical layout flex"><div class="widget-area vertical layout"></div></colab-form></div><div class="output"><div class="output-header"></div><div class="output-content"><div class="output-info"><div class="output-icon clear_outputs_enabled output-icon-selected" title="Clear output

executed by SIRESHA LINGALA
Wednesday, July 20, 2022 (4 days ago)
executed in 28.301s"><iron-icon class="collaborator collaborator-img-me collaborator-img-selected"></iron-icon>
          <iron-icon icon="icons:cancel" command="clear-focused-or-selected-outputs">
          </iron-icon>
        </div></div><div class="output-iframe-container"><div class="output-iframe-sizer"><div><div><colab-static-output-renderer tabindex="0" role="group"><div><div class="stream output_text"><pre>Your bot is ready to talk! Type your messages here or send '/stop'.
hhhheyy
<span style="color: var(--ansi-bright-green);">Hey! How are you?</span><span>
good
</span><span style="color: var(--ansi-bright-green);">Great, carry on!</span><span>
okiee
</span><span style="color: var(--ansi-bright-green);">Bye</span><span>
/stop
</span></pre></div></div><div></div></colab-static-output-renderer></div></div></div></div></div></div></div></div><div class="add-cell">
             <hr>
           </div></div><div class="cell text" id="cell-YwcPLi-euEu9" tabindex="-1" style=""><div class="cell-toolbar sticky"></div><div class="main-content" elevation="0"><div class="cell-mask"></div><span class="imported-info-area"></span><div class="toolbar-root"></div><div class="editor-container horizontal"><div class="editor-root"></div><div class="text-top-div"><div class="markdown"><span><p>Double-click (or enter) to edit</p>
    ...
    <div class="notebook-scroll-shadow"></div>
      ...
      <colab-resizer style="height: 33.3%" class="sn-resize no-tabs"><div class="resizer-thumb"></div>
        <!--?lit$096929133$--><colab-tab-pane class="layout vertical grow no-tabs" align="horizontal"><!---->
  <div class="layout vertical grow">
    <div class="tab-pane-header layout horizontal noshrink">
      <paper-tabs selected="0" noink="" class="layout grow" scrollable="" role="tablist" tabindex="0" dir="null">
      </paper-tabs>
  ...
  <div class="layout vertical grow">
    ...
    <div class="layout vertical grow tab-pane-container">
      ...
      <div class="proxies"><div><colab-dom-lifecycle-events></colab-dom-lifecycle-events><iframe allow="" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-popups-to-escape-sandbox" src="./CHATBOT_files/outputframe(1).html" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe></div><div><colab-dom-lifecycle-events></colab-dom-lifecycle-events><iframe allow="accelerometer; autoplay; camera; gyroscope; magnetometer; microphone; serial; usb; xr-spatial-tracking; clipboard-write" sandbox="allow-downloads allow-forms allow-pointer-lock allow-popups allow-same-origin allow-scripts allow-popups-to-escape-sandbox" src="./CHATBOT_files/outputframe(2).html" style="width: 1px; height: 1px; position: absolute; top: -100px;"></iframe></div></div>
    <colab-file-viewer-manager></colab-file-viewer-manager></div>
  <colab-status-bar style="min-height: inherit;"></colab-status-bar></div><div class="goog-menu colab-styled-scroller" id="file-menu" role="menu" aria-haspopup="true" style="user-select: none; max-height: 601px; visibility: visible; left: 64px; top: 62px; display: none;"><!--?lit$096929133$--><!--?lit$096929133$--><div command="locate-in-drive" class="goog-menuitem" role="menuitem" id=":3" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Locate in Drive</div></div><div command="open-in-playground" class="goog-menuitem" role="menuitem" id=":4" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Open in playground mode</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":5" style="user-select: none;"></div><!--?lit$096929133$--><div command="new" class="goog-menuitem" role="menuitem" id=":6" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->New notebook</div></div><div command="open" class="goog-menuitem" role="menuitem" id=":7" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Open notebook<span class="goog-menuitem-accel">Ctrl+O</span></div></div><div command="import-notebook" class="goog-menuitem" role="menuitem" id=":8" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Upload notebook</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":9" style="user-select: none;"></div><!--?lit$096929133$--><div command="rename" class="goog-menuitem" role="menuitem" id=":a" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Rename</div></div><div command="move-notebook" class="goog-menuitem" role="menuitem" id=":b" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Move</div></div><div command="trash" class="goog-menuitem" role="menuitem" id=":c" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Move to trash</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":d" style="user-select: none;"></div><!--?lit$096929133$--><div command="clone" class="goog-menuitem" role="menuitem" id=":e" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Save a copy in Drive</div></div><div command="copy-to-gist" class="goog-menuitem" role="menuitem" id=":f" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Save a copy as a GitHub Gist</div></div><div command="copy-to-github" class="goog-menuitem" role="menuitem" id=":g" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Save a copy in GitHub</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":h" style="user-select: none;"></div><!--?lit$096929133$--><div command="save" class="goog-menuitem  " role="menuitem" id=":i" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Save<span class="goog-menuitem-accel">Ctrl+S</span></div></div><div command="save-and-checkpoint" class="goog-menuitem  " role="menuitem" id=":j" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Save and pin revision<span class="goog-menuitem-accel">Ctrl+M S</span></div></div><div command="show-history" class="goog-menuitem  " role="menuitem" id=":k" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Revision history</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":l" style="user-select: none;"></div><!--?lit$096929133$--><div class="goog-submenu goog-menuitem" id="download-submenu-menu-button" role="menuitem" aria-haspopup="true" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;">
                <!--?lit$096929133$-->Download
              <span class="goog-submenu-arrow" style="user-select: none;">►</span></div></div><div command="print" class="goog-menuitem  " role="menuitem" id=":p" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Print<span class="goog-menuitem-accel">Ctrl+P</span></div></div><!--?--></div><div class="goog-menu" id="download-submenu-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$096929133$--><!--?lit$096929133$--><div command="download-ipynb" class="goog-menuitem  " role="menuitem" id=":n" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Download .ipynb</div></div><div command="download-python" class="goog-menuitem  " role="menuitem" id=":o" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Download .py</div></div><!--?--></div><div class="goog-menu" id="edit-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$096929133$--><!--?lit$096929133$--><div command="undo" class="goog-menuitem  " role="menuitem" id=":r" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Undo</div></div><div command="redo" class="goog-menuitem  " role="menuitem" id=":s" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Redo</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":t" style="user-select: none;"></div><!--?lit$096929133$--><div command="select-all" class="goog-menuitem  " role="menuitem" id=":u" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Select all cells</div></div><div command="cut" class="goog-menuitem  " role="menuitem" id=":v" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Cut cell or selection</div></div><div command="copy" class="goog-menuitem  " role="menuitem" id=":w" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Copy cell or selection</div></div><div command="paste" class="goog-menuitem  " role="menuitem" id=":x" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Paste</div></div><div command="delete-cell-or-selection" class="goog-menuitem  " role="menuitem" id=":y" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Delete selected cells</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":z" style="user-select: none;"></div><!--?lit$096929133$--><div command="find" class="goog-menuitem  " role="menuitem" id=":10" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Find and replace</div></div><div command="find-next" class="goog-menuitem  " role="menuitem" id=":11" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Find next</div></div><div command="find-previous" class="goog-menuitem  " role="menuitem" id=":12" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Find previous</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":13" style="user-select: none;"></div><!--?lit$096929133$--><div command="notebook-settings" class="goog-menuitem  " role="menuitem" id=":14" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Notebook settings</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":15" style="user-select: none;"></div><!--?lit$096929133$--><div command="clear-outputs" class="goog-menuitem  " role="menuitem" id=":16" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Clear all outputs</div></div><!--?--></div><div class="goog-menu" id="view-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$096929133$--><!--?lit$096929133$--><div command="show-toc-pane" class="goog-menuitem goog-option" role="menuitemcheckbox" aria-checked="false" id=":18" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><div class="goog-menuitem-checkbox" style="user-select: none;"><iron-icon></iron-icon></div><!--?lit$096929133$-->Table of contents</div></div><div command="show-fileinfo" class="goog-menuitem  " role="menuitem" id=":19" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Notebook info</div></div><div command="show-executedcode" class="goog-menuitem  " role="menuitem" id=":1a" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Executed code history</div></div><div command="toggle-comments-visibility" class="goog-menuitem goog-option" role="menuitemcheckbox" aria-checked="false" id=":1b" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><div class="goog-menuitem-checkbox" style="user-select: none;"><iron-icon></iron-icon></div><!--?lit$096929133$-->Comments sidebar</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":1c" style="user-select: none;"></div><!--?lit$096929133$--><div command="collapse-sections" class="goog-menuitem  " role="menuitem" id=":1d" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Collapse sections</div></div><div command="expand-sections" class="goog-menuitem  " role="menuitem" id=":1e" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Expand sections</div></div><div command="save-section-layout" class="goog-menuitem  " role="menuitem" id=":1f" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Save collapsed section layout</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":1g" style="user-select: none;"></div><!--?lit$096929133$--><div command="hide-code" class="goog-menuitem  " role="menuitem" id=":1h" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Show/hide code</div></div><div command="toggle-output" class="goog-menuitem  " role="menuitem" id=":1i" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Show/hide output</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":1j" style="user-select: none;"></div><!--?lit$096929133$--><div command="focus-next-tab" class="goog-menuitem  " role="menuitem" id=":1k" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Focus next tab</div></div><div command="focus-previous-tab" class="goog-menuitem  " role="menuitem" id=":1l" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Focus previous tab</div></div><div command="move-tab-to-next" class="goog-menuitem  " role="menuitem" id=":1m" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Move tab to next pane</div></div><div command="move-tab-to-prev" class="goog-menuitem  " role="menuitem" id=":1n" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Move tab to previous pane</div></div><!--?--></div><div class="goog-menu" id="insert-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$096929133$--><!--?lit$096929133$--><div command="insert-cell-below" class="goog-menuitem  " role="menuitem" id=":1p" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Code cell</div></div><div command="add-text" class="goog-menuitem  " role="menuitem" id=":1q" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Text cell</div></div><div command="add-section-header" class="goog-menuitem  " role="menuitem" id=":1r" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Section header cell</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":1s" style="user-select: none;"></div><!--?lit$096929133$--><div command="open-scratch-code-cell" class="goog-menuitem  " role="menuitem" id=":1t" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Scratch code cell</div></div><div command="snippets" class="goog-menuitem  " role="menuitem" id=":1u" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Code snippets</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":1v" style="user-select: none;"></div><!--?lit$096929133$--><div command="add-form-field" class="goog-menuitem  " role="menuitem" id=":1w" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Add a form field</div></div><!--?--></div><div class="goog-menu" id="runtime-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$096929133$--><!--?lit$096929133$--><div command="runall" class="goog-menuitem  " role="menuitem" id=":1y" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Run all</div></div><div command="runbefore" class="goog-menuitem  " role="menuitem" id=":1z" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Run before</div></div><div command="runfocused" class="goog-menuitem  " role="menuitem" id=":20" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Run the focused cell</div></div><div command="runselected" class="goog-menuitem  " role="menuitem" id=":21" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Run selection</div></div><div command="runafter" class="goog-menuitem  " role="menuitem" id=":22" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Run after</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":23" style="user-select: none;"></div><!--?lit$096929133$--><div command="interrupt" class="goog-menuitem  " role="menuitem" id=":24" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Interrupt execution</div></div><div command="restart" class="goog-menuitem  " role="menuitem" id=":25" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Restart runtime</div></div><div command="restart-and-run-all" class="goog-menuitem  " role="menuitem" id=":26" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Restart and run all</div></div><div command="powerwash-current-vm" class="goog-menuitem  " role="menuitem" id=":27" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Disconnect and delete runtime</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":28" style="user-select: none;"></div><!--?lit$096929133$--><div command="change-runtime-type" class="goog-menuitem  " role="menuitem" id=":29" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Change runtime type</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":2a" style="user-select: none;"></div><!--?lit$096929133$--><div command="manage-sessions" class="goog-menuitem  " role="menuitem" id=":2b" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Manage sessions</div></div><div command="view-runtime-logs" class="goog-menuitem  " role="menuitem" id=":2c" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->View runtime logs</div></div><!--?--></div><div class="goog-menu" id="tools-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$096929133$--><!--?lit$096929133$--><div command="show-command-palette" class="goog-menuitem  " role="menuitem" id=":2e" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Command palette</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":2f" style="user-select: none;"></div><!--?lit$096929133$--><div command="preferences" class="goog-menuitem  " role="menuitem" id=":2g" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Settings</div></div><div command="shortcuts" class="goog-menuitem  " role="menuitem" id=":2h" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Keyboard shortcuts</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":2i" style="user-select: none;"></div><!--?lit$096929133$--><div command="open-differ" class="goog-menuitem  " role="menuitem" id=":2j" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Diff notebooks</div></div><!--?--></div><div class="goog-menu" id="help-menu" role="menu" aria-haspopup="true" style="display: none; user-select: none;"><!--?lit$096929133$--><!--?lit$096929133$--><div command="faq" class="goog-menuitem  " role="menuitem" id=":2l" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Frequently asked questions</div></div><div command="view-relnotes" class="goog-menuitem  " role="menuitem" id=":2m" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->View release notes</div></div><div command="snippets" class="goog-menuitem  " role="menuitem" id=":2n" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Search code snippets</div></div><!--?--><div class="goog-menuseparator goog-menuitem-disabled" aria-disabled="true" role="separator" id=":2o" style="user-select: none;"></div><!--?lit$096929133$--><div command="report-bug" class="goog-menuitem  " role="menuitem" id=":2p" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Report a bug</div></div><div command="send-feedback" class="goog-menuitem  " role="menuitem" id=":2q" style="user-select: none;"><div class="goog-menuitem-content" style="user-select: none;"><!--?lit$096929133$-->Send feedback</div></div><!--?--></div><div class="doc-comments-area" style="display: none;"><div class="doc-comments-buttons"><paper-button command="add-comment" role="button" tabindex="0" animated="" elevation="0" aria-disabled="false"><iron-icon icon="editor:insert-comment"></iron-icon> Add a comment</paper-button></div></div><div class="thumbnail"></div><div class="monaco-aria-container"><div class="monaco-alert" role="alert" aria-atomic="true"></div><div class="monaco-alert" role="alert" aria-atomic="true"></div><div class="monaco-status" role="complementary" aria-live="polite" aria-atomic="true"></div><div class="monaco-status" role="complementary" aria-live="polite" aria-atomic="true"></div></div><iframe id="apiproxy23a462b956d57d6f7c8deac47c3ca2b9cdf376dc0.1834775993" name="apiproxy23a462b956d57d6f7c8deac47c3ca2b9cdf376dc0.1834775993" src="./CHATBOT_files/proxy.html" tabindex="-1" aria-hidden="true" style="width: 1px; height: 1px; position: absolute; top: -100px; display: none;"></iframe><div><div class="grecaptcha-badge" data-style="bottomright" style="width: 256px; height: 60px; position: fixed; visibility: hidden; display: block; transition: right 0.3s ease 0s; bottom: 14px; right: -186px; box-shadow: gray 0px 0px 5px; border-radius: 2px; overflow: hidden;"><div class="grecaptcha-logo"><iframe title="reCAPTCHA" src="./CHATBOT_files/anchor.html" width="256" height="60" role="presentation" name="a-s737sm5nsvh9" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><div class="grecaptcha-error"></div><textarea id="g-recaptcha-response-100000" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div><iframe style="display: none;" src="./CHATBOT_files/saved_resource.html"></iframe></div><iframe src="./CHATBOT_files/bscframe.html" style="display: none;"></iframe><iron-a11y-announcer></iron-a11y-announcer></body></html>